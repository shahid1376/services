...
class Admission extends CI_Controller {
    ...
    public function checkFormNo_then_download(){
        ...
        //LOGO....//
        $pdf->Image(base_url()."assets/img/logo2.png",0.30,0.2, 0.75,0.75, "PNG");
        ...
        $pdf->Image(base_url().'assets/img/download.jpg',6.5, 1.15+$Y, 0.95, 1.0, "JPG");
        $pdf->SetFont('Arial','',8);
        ...
        $pdf->SetFont('Arial','',7);
        $pdf->SetXY($xx,5.4+$yy);
        $pdf->Cell($boxWidth,0.2,$data['sub8ap1'] != 1 ? '':   '    '.'8. '. $this->GetSubNameHere($data['sub8']),1,0,'L',1);
        ...
        $pdf->Cell($boxWidth,0.2,$data['sub5Ap2'] != 1 ? '':  '    '.'5. '.  $this->GetSubNameHere($data['sub5']),1,0,'L',1);

        $pdf->SetFont('Arial','',7);
        $pdf->SetXY($xangle,5.0+$yy);
        $pdf->Cell($boxWidth,0.2,$data['sub6Ap2'] != 1 ? '':  '    '.'6. '.  $this->GetSubNameHere($data['sub6']),1,0,'L',1);

        $pdf->SetFont('Arial','',7);
        $pdf->SetXY($xangle,5.2+$yy);
        $pdf->Cell($boxWidth,0.2,$data['sub7Ap2'] != 1 ? '':  '    '.'7. '.  $this->GetSubNameHere($data['sub7']),1,0,'L',1);
        ...
        $pdf->Image(base_url().'assets/img/download.jpg',6.5, 10.3+$Y, 0.95, 1.0, "JPG");
        $pdf->SetFont('Arial','',8);
    ...
    function GetDueDate(){
        ...
        $dueDate='';
        $single_date= '10-08-2016';  $double_date= '23-12-2015';  $tripple_date= '31-12-2015';
        $today = date("d-M-Y");
    ...
    public function makefee($cat,$Speciality,$sub7,$sub8,$grp_cd,$sub1ap1,$sub2ap1,$sub3ap1,$sub4ap1,$sub5ap1,$sub6ap1,$sub7ap1,$sub8ap1,$sub1ap2,$sub2ap2,$sub3ap2,$sub4ap2,$sub5ap2,$sub6ap2,$sub7ap2,$sub8ap2){
        ...
        if($Speciality == 0 && $grp_cd == 1 && ($sub1ap1 == 1 || $sub2ap1 == 1 || $sub3ap1 == 1 || $sub4ap1 == 1 || $sub5ap1 == 1 || $sub6ap1 == 1 || $sub7ap1 == 1 || $sub8ap1 == 1)){
            $AdmFee = 700;    
        }
    ...
    public function makecat($cattype, $exam_type,$marksImp,$selgrp,$prevgrp = 2){
    ...
    public function NewEnrolment_insert(){
        ...
        //DebugBreak();
        @$cat = $this->makecat($cattype, $examtype,$marksImp,$selgrp);
        $cat09 = $cat['cat09'];
        $cat10 = $cat['cat10'];
        ...
        $AdmFee =  $this->makefee($cat,$Speciality,$sub7,$sub8,$grp_cd,$sub1ap1,$sub2ap1,$sub3ap1,$sub4ap1,$sub5ap1,$sub6ap1,$sub7ap1,$sub8ap1,$sub1ap2,$sub2ap2,$sub3ap2,$sub4ap2,$sub5ap2,$sub6ap2,$sub7ap2,$sub8ap2);
