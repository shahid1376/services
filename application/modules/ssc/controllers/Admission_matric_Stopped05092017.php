...
class Admission_matric_Stopped05092017 extends CI_Controller {
    ...
    public function cutlist()
    {
        ...
        foreach ($result as $key=>$data) 
        {
            ...
            // DebugBreak();
             $pdf->Image(DIRPATH.$data["PicPath"],$col6+0.1,$ln[$countofrecords]+0.1 , 0.40, 0.40, "JPG"); 
    ...
    {    
        ...
        if($this->session->flashdata('NewEnrolment_error')){
           ...
           // echo '<pre>'; print_r($RegStdData);exit();
        }
        $this->load->view('common/menu.php',$data);
    ...
    public function Print_Admission_matric_Form_Proofreading_Groupwise()
    {
        ...
        foreach ($result as $key=>$data) 
        {
            ...
            $pdf->Cell(1.25,1.4,'',1,0,'C',0);
             $pdf->Image(DIRPATH.$data["PicPath"],6.5, 1.55+$Y, 1.25, 1.4, "JPG");
