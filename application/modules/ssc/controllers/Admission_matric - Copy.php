  ...
  /// DebugBreak();
    ...
    public function ReAdmission_check()
    {
        ...
        else
        {
            ...
            $year = 2015;
            $RegStdData = array('data'=>$this->Admission_matric_model->EditEnrolement_data($formno,$year,$Inst_Id),'isReAdm'=>'1','Oldrno'=>$OldRno);

            $filledinfo['error'] = "";
            //$this->session->set_flashdata('isReAdm','1');
            $this->load->view('common/menu.php',$data);
            $this->load->view('Admission_matric/9th/Edit_Enrolement_form.php',$RegStdData);   
