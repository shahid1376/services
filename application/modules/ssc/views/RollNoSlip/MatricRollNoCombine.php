    ...
    <tr>
        ...
        <td width="95%" align="left" >  
            <table>
                ...
                <tr>
                    <td width="30%"></td>
                    <td style="line-height: 11px;font-size: 9px; font-weight: bold;" width="70%" align="left"> <?php if($errmessage == null) echo '(PROVISIONALLY)'; else{ echo ' (PROVISIONALLY OBJECTION SLIP)';}?> </td>
                </tr>
...
if($errmessage == null) {?>
    ...
    <table>
        <tr>
            <td align="center" style="font-size: 22px; font-weight: bold;color:red"> <?php echo "Slip is not issued due to ".$errmessage?>.</td>
        </tr>
    </table>
