<!DOCTYPE html>
    ...
    <body>
        <div style="text-align: center;" >
            ...
            <label  class="centers">ROLL NUMBER SLIP <br>(WITH DATE SHEET) FOR <?= $info[0]['Class'] ?> <?php if($info[0]['Session'] ==1) echo 'ANNUAL'; else echo 'SUPPLY'; ?>  EXAMINATION, <?= $info[0]['Year'] ?> </label>  
        ...
        <table style="  margin-top: -12px;">
            <tr>
                ...
                <td>
                    <table>
                        <tr>
                            <td> <img alt="" src="assets/pdfs/<?= $barcode?>" /></td> 
                            <td ><img alt="" src="assets/img/download.jpg" style="width:85px; height:90px;">
                            </td> 
                        </tr>
                    </table>
                </td>
        ...
        <table style="  margin-top: -10px;">
            <tr>
                <td><label class="smallsize">CENTER</label></td>
                <td ><label class="smallsize"><strong>: <?= $info[0]['cent_cd'].'-'.$info[0]['Cent_Name']?></strong></label></td>

            </tr>
        </table>
        <img src="assets/img/Note.jpg" style="margin-left: 580px;margin-top: 200px; width:160px; position: absolute;" >
        
        <table  class=borders border="1" style="width:50%; " cellpadding="1" cellspacing="0" >
        ...
        <table  class=borders border="1" style="width:100%; margin-top: 3px;" cellpadding="2" cellspacing="0" >
            <tr class="noBorder" height="2px">
                <td align="center" colspan="6" ><label Style="text-align:center; font-weight: bold;">PRACTICAL-PART(II) </label> 

                </td>
            </tr>
            <tr><td width="5px" align="center"><label  class="smallsize" style="text-align: center;"><b>S#</b></label></td>
                ...
                <td width="30px" align="center"><label class="smallsize"><b>Batch</b></label></td></tr>
            <tr>
        ...
        <table style="width:100%; height: 1%;     margin-top: -34px;"  cellpadding="0" cellspacing="0">
            <tr>
                <td ><label class="smallsize"><b>To </b></label></td>
                <td ><label class="smallsize">ROLL NO: <?= $info[0]['Rno']?></label></td>
                <td rowspan="4">
                    <!-- <img alt="" src="assets/img/256.JPG" style=" width: 35px; float: right; text-align: center; height: 38px;" />-->
            </td>
            </tr>
            <tr>
                <td ><label class="smallsize">Name</label></td>
