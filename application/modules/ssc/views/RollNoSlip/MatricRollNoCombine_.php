...
<table width="100%" >
    <tr>
        <td width="10%"> <img src="assets/img/icon2.png" alt="" style="height:50px;" ></td>
        <td width="90%">  
            <div style="text-align: center;    font-size: 10px !important; " >
                ...
                <label  class="centers"><br>ROLL NUMBER SLIP (WITH DATE SHEET) FOR S.S.C <?php if($Session ==1) echo 'ANNUAL'; else echo 'SUPPLY'; ?>  EXAMINATION, <?= $Year ?> </label>  
                <label class="centers"><b><br>(PROVISIONALLY)</b></label>
...
<table width="100%">
    <tr>
        <td  width="60%">
            <table width="100%">
                <tr>
                    <td width="20%"><label >ROLL NO</label></td>
                    <td width="80%"><label ><strong>: <?= $Rno?></strong></label></td>
                </tr>
                <tr>
                    <td width="20%"><label >NAME</label></td>
                    <td width="80%"><label style="font-size: 10px;" >: <?= $Name?></label></td>

                </tr>
                <tr>
                    <td width="20%"><label >FATHER's NAME</label></td>
                    <td width="80%"><label style="font-size: 10px;">: <?= $FathersName?></label></td>

                </tr>
                <tr>
                    <td width="20%"><label >DATE OF BIRTH </label></td>
                    <td width="80%"><label style="font-size: 10px;">:  <?= $DOB?></label></td>
                </tr>
                <tr>
                    <td width="20%"><label>CENTER</label></td>
                    <td width="80%"><label><strong>: <?= $cent_cd.'-'.$Cent_Name?></strong></label></td>
                </tr>
            </table>
        </td>
        <td width="40%">
            <table width="100%">
                <tr>
                    <td align="left" width="60%" style=" " > <img align="middle" alt="" src="assets/pdfs/<?= $barcode?>" style="height: 60px;" /></td> 
                    <td  align="right" width="40%" >
                        <table>
                            <tr>
                                <td  align="center" ><p style=" font-weight: bold">FormNo:<?= $formno?></p></td>
                            </tr>

                            <tr>
                                <td  align="center" > <img alt="" src="assets/<?= $picpath?>" style="height:60px;"></td>
                            </tr>
                            <tr>
                                <td align="center"><p style="font-weight: bold"><?php if($Gender==1) echo 'MALE'; if($Gender==2) echo 'FEMALE';   ?></p></td>
                            </tr>
                        </table>
        ...
        <td width="80%">
            ...
            <table   border="1"  cellpadding="1" cellspacing="0" width="100%"  >
                ...
                <tr>
                    ...
                    <td width="60%" align="center"><b>SUBJECTS(s)</b> </td>
...
<table   border="1"  cellpadding="1" cellspacing="0" width="100%"   >
    ...
    if(@$slips[$tprcount]['prcount'] > 0)
    {
        ...
        { 
            $prcount++;?>
            <tr>
                <td align="center" valign="middle"><?= $prcount?></td>
                <td><?= $slips[$l+$tprcount]['sub_Name']?></td>
                <td><?= $slips[$l+$tprcount]['lab_Name']?></td>
    ...
    <tr>
    <td>1</label></td>
    <td> <label >ELEMENTS OF HOME ECONOMICS</label></td>
    <td><label >47-GOVT.H/S/S NO.2 SIALKOT</label></td>
    <td>10-10-2015</label></td>
    <td>02:30 PM</label></td>
    <td>III</label></td>
    </tr>
    <tr>
    <td>2</label></td>
    <td> <label >COMPUTER SCIENCE </label></td>
    <td><label >47-GOVT.H/S/S NO.2 SIALKOT</label></td>
    <td>10-10-2015</label></td>
    <td>02:30 PM</label></td>
    <td>III</label></td>
...
<table width="100%"  >
    <tr>
        ...
        <td width="80%" align="right">
            <img alt="" src="assets/img/256.JPG" style=" height:250px;  text-align: right;" />
        </td>
    </tr>
</table>
<table>
    <tr>
        <td width="72%">
            <table style="width:100%; height: 1%;"  cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td width="100%" colspan="6"><img src="assets/img/headsign.jpg" style="height: 60px;width:250px" alt=""></td>
                </tr>
                <tr>
                    <td width="15%"><label >Institute Name</label></td>
                    <td width="85%" colspan="5"><label >:<?= $inst_cd."-".$inst_name?></label></td>
                </tr>
                <!-- <tr>
                <td width="15%"><label>Address</label></td>
                <td  width="85%" colspan="3" ><label >:<?php  //$address." District: ".$dist_name; ?></label></td>
                </tr>-->
                <tr>
                    <td width="15%"><label >Zone</label></td>
                    <td width="35%"><label>:<?= $Zone_Code."-".$Zone_Name?></label></td>
                    <td width="5%"><label >Teh</label></td>
                    <td width="25%"><label>:<?= $teh_name?></label></td>
                    <td width="5%"><label >Distt</label></td>
                    <td width="15%"><label>:<?= $dist_name?></label></td>
                </tr>
            </table>
        </td>
