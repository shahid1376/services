...
<table width="100%">
    <tr>
        <td width="10%"> <img src="assets/img/icon2.png" alt="" style="width:130px; height:120px" ></td>
        <td width="95%" align="left" >  
            <table>
                ...
                <tr>
                <td width="6%"></td>
                    <td style="line-height: 7px;font-size: 9px;" align="left" width="94%">ROLL NUMBER SLIP (WITH DATE SHEET) FOR 9th <?php if($Session ==1) echo 'ANNUAL'; else echo 'SUPPLY'; ?>  EXAMINATION, <?= $Year ?>   </td>
                </tr>
                <tr>
                 <td width="30%"></td>
                ...
                <tr>
                    <td>
                        <table   border="1" width="100%"  >
                            ...
                            <tr class="noBorder" height="2px" style="background-color:#D0D0D0;line-height: 15px;">
...
<table width="100%"  >
    <tr>
        ...
        <td width="80%" align="right">
            <img alt="" src="assets/img/256(9th).JPG" style="width:500px;height:245px;   text-align: right;" />
        </td>
    </tr>
</table>
<table>
        ...
        <td width="72%">
            <table style="width:100%; height: 1%;"  cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="84%" colspan="5"><label style="font-size: 8px; font-weight: bold;">:<?= $inst_cd."-".$inst_name?></label></td>
                </tr>

                <tr>
                    <td width="15%"><label >Zone</label></td>
                    <td width="25%"><label>  :<?= $Zone_Code."-".$Zone_Name?></label></td>
                    <td width="5%"><label >Teh</label></td>
                    <td width="20%"><label>:<?= $teh_name?></label></td>
                    <td width="5%"><label >Distt</label></td>
                    <td width="30%"><label>:<?= $dist_name?></label></td>
                </tr>
            </table>
        </td>
