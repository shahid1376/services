                ...
                <div class="widget no-margin">
                  ...
                  <div id="dt_example" class="example_alt_pagination">
                    ...
                    <hr>
                     ...
                     <a href="<?php echo base_url(); ?>Admission_matric/forwarding_pdf" class="link offset5 blink_text" style="font-size: x-large;" target="_blank" >Download Farwarding letter. </a>
                       <a href="<?php echo base_url(); ?>Admission_matric/financeReoprt" target="_blank"  class="link offset5 blink_text" style="font-size: x-large;display: block;margin-left: 40% !important;" >Download Finance Farwarding letter. </a> 
                     </div>
                     </div>
