            ...
            <div class="span12">
                <div class="widget">
                    <div class="widget-header">
                        <div class="title">
                            Matric Private  Admission Form  For Other Board Candidates.
                        </div>
                    </div>
                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>index.php/Admission/NewEnrolment_insert" method="post" enctype="multipart/form-data" name="myform" id="myform">
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <input type="hidden" value="<?php  if(!empty($data['name'])) echo 1; else echo 0; ?>" id="isNotFresh" name="isNotFresh" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <input class="span3"  type="text" id="cand_name" style="text-transform: uppercase;" name="cand_name" placeholder="Candidate Name" maxlength="60"  value="<?php  echo @$data['name']; ?>" <?php // if(!empty(@$data['Fname'])) echo "readonly='readonly'";  ?>>
                                    <label class="control-label span2" for="lblfather_name">
                                        Father's Name :
                                    </label> 
                                    <input class="span3" id="father_name" name="father_name" style="text-transform: uppercase;" type="text" placeholder="Father's Name" maxlength="60"  value="<?php echo  @$data['Fname']; ?>"  <?php // if(!empty(@$data['Fname'])) echo "readonly='readonly'";  ?> required="required">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label span1" >
                                ...
                                <div class="controls controls-row">
                                    <input class="span3" type="text" id="bay_form" name="bay_form" maxlength="15" placeholder="Bay Form No." value="<?php echo @$data['BForm'];?>" <?php //if(!empty($data['BForm'])) echo "readonly='readonly'";  ?>  required="required" >
                                    <label class="control-label span2" for="father_cnic">
                                        Father's CNIC :
                                    </label> 
                                    <input class="span3" id="father_cnic" name="father_cnic" type="text" placeholder="34101-1111111-1"  value="<?php  echo @$data['FNIC'];?>" <?php //if(!empty($data['FNIC'])) echo "readonly='readonly'";  ?>  required="required" >
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label span1" >
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <input type="text" name="preResult" required="required" id="preResult" value="<?php echo  @$data['preResult'] ; ?>" class="span3" placeholder="i.e 350 or E,U">
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label span1" >
                            ...
                            <div class="control-group" >
                                ...
                                <div class="controls controls-row">
                                    <input class="span3" type="text" id="oldrno" style="text-transform: uppercase;" name="oldrno" value="<?php echo @$data['rno']; ?>" required="required" maxlength="6" >
                                    <label class="control-label span2" >
                                        Year:
                                    </label> 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <input type="hidden" class="span3" id="oldClass" name="oldClass"  value="<?php //if(!empty($SSC_CLASS)) echo @$SSC_CLASS; else 0;?>"/>     
