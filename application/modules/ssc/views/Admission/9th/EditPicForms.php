                        ...
                        <div id="dt_example" class="example_alt_pagination">
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                                ...
                                <tbody>
                                    ...
                                    $n++;
                                        $size = @getimagesize(DIRPATH9th.'/'.$Inst_Id.'/'.$vals['PicPath']);
                                        $size = count(@$size);
                                    if(!file_exists(DIRPATH9th.'/'.$Inst_Id.'/'.$vals['PicPath']) || $size == 1)
                                    {
                                    ...
                                    <td>'.date("d-m-Y", strtotime($vals["Dob"])).'</td>
                                     <td>                        
                                     <form id="uplodpics" class="form-horizontal no-margin" action="'.base_url().'/index.php/Admission_9th_reg/uplaodpics" method="post" enctype="multipart/form-data">
