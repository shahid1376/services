            ...
            <div class="widget-body">
                ...
                <form enctype="multipart/form-data" id="options" name="options" method="post" action="" >
                    <table>
                        ...
                        <tr>
                            <td width="50%">
                                <label class=myEngParagraph >  Note:-Last Date of Online Admissions and Submission of Hard Copy for Matric <?php if(Session == "1"){echo "Annual";} else echo "Supply" ?> Examination with (Single fee) is <b style="color: red;font-size: 20px;"> <?php echo SingleDateFee9th ?></b>.</label>  
                            </td>
                            <td width="50%"  >
                                <label class=myUrduParagraph>داخلہ فارسنگل فیس کے ساتھ آن لائن کرنے اور بھجوانے کی آخری تاریخ     <label class="label" style="color: red;font-size: 18px;"> <?php echo SingleDateFee9th; ?> </label>  ہے                                         </label>
                            </td>
                        </tr>
                    </table>
