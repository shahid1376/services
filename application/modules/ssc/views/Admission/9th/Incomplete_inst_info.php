                    ...
                    <div class="widget-header">
                     ...
                     <img src="assets/img/rezone_instruction.jpg" style="height:150px;margin-left: 30%;">
                        ...
                        <div class="control-group">
                         ...
                         <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>Admission_9th_reg/updatezone" method="post" enctype="multipart/form-data" name="myform" id="myform">
