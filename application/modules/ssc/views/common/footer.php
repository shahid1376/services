...
<script src="<?php echo base_url(); ?>ssc/assets/js/highcharts.js"></script>
<script src="<?php echo base_url(); ?>ssc/assets/js/exporting.js"></script>
<!-- Sparkline JS -->
<script src="<?php echo base_url(); ?>ssc/assets/js/jquery.sparkline.js"></script>
...
<script type="">
    ...
    jQuery.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>ssc/Dashboard/getstats/",
        ...
        success: function(data) {
            ...
            Highcharts.chart('area_chart', {
                ...
                subtitle: {
                    text: 'Source: <a href="http:www.bisegrw.edu.pk">' +
                    'bisegrw.edu.pk</a>'
                },
...
/* $(document).ready(function(){
    ...
    window.onbeforeunload = function(){
        if(out)
        {
           // $.ajax({url:"http://ssc.bisegrw.edu.pk/index.php/login/log_out", async:false});
            ...
            if(gend ==0  || gend == '' || gend == null || gend==undefined)
            {
               ...
               alertify.error("Select Zone First.");
                ...
                jQuery.ajax({
                    ////debugger;
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "Admission_9th_pvt_stp/getzone/",
                    dataType: 'json',
                    data: {tehCode: tehId,gend:gend},
                    beforeSend: function() {  $('.mPageloader').show(); },
                    complete: function() { $('.mPageloader').hide();},
            ...
            if(gend ==0  || gend == '' || gend == null || gend==undefined)
            {
               ...
               alertify.error("Select Zone First.");
                ...
                jQuery.ajax({
                    ...
                    type: "POST",
                    url: "<?php echo base_url(); ?>Admission_9th_pvt_stp/getcenter/",
                    dataType: 'json',
                    data: {pvtZone:tehId,gend:gend},
                    beforeSend: function() {  $('.mPageloader').show(); },
                    complete: function() { $('.mPageloader').hide();},
