...
<script src="<?php echo base_url(); ?>ssc/assets/js_matric/jquery-1.8.3.js"></script>
<script src="<?php echo base_url(); ?>ssc/assets/js/bootstrap.js"></script>
<script src="<?php echo base_url(); ?>ssc/assets/js_matric/jquery.validate.js"></script>
<script src="<?php echo base_url(); ?>ssc/assets/js_matric/jquery.maskedinput.js"></script>
<script src="<?php echo base_url(); ?>ssc/assets/js_matric/noty/jquery.noty.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>ssc/assets/js_matric/noty/layouts/bottom.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ssc/assets/js_matric/noty/themes/default.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>ssc/assets/js_matric/jquery-ui.js"></script>
    ...
    function makebatch_groupwise(){
        ...
        if(option == "3")
        {
            if($("#std_groups").val() == ""  || $("#std_groups").val() == 0)
            {
               ...
               var msg = "Are You Sure you want to make Batch ?" // var msg = "<img src='<?php echo base_url(); ?>ssc/assets/img/note_for_batch.jpg' alt='logo' style='width:800px; height: auto;' />"
