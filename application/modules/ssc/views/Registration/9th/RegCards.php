            ...
            <div class="span12">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                             9th Registration Cards Printing<a data-original-title="" id="notifications">s</a>
                        </div>
                                           </div>
...
<!--                        <hr>-->
                        ...
                        <div class="control-group">
                            <div class="controls controls-row">
                                <input type="submit" name="print_regCards" id="print_regCards"class="btn btn-large btn-info" value="Print Registration Cards">
